...
class Parser {
	public:
		...
		Parser(ErrorHandler *errHandler);
		~Parser();
		 ...
		 */
		ast::Program *parse(const std::vector<Token> &tokens, Settings *settings);
		...
		ast::Identifier *expectIdentifierAfter(TokIterator &i, const std::string &after);
